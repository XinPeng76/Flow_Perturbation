...
from src.MC import run_mcmc_and_save, get_vjp_score
...
if __name__ == '__main__':
    ...
    ux = ux_init.clone()
    eps = torch.randn_like(xT)
    run_mcmc_and_save(nmcmc, ux, x0, xT, eps, log_omega, device, back_coeff,get_log_omega_J, tmax=tmax, K_x=K_x, if_eps=False,path='NWell_MCMC1000/GMM-1000-Hutch1')
