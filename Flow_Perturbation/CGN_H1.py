...
from src.MC import  get_vjp_score, run_mcmc_and_save_CoM
...
if __name__ == '__main__':
    ...
    eps = torch.randn_like(xT)
    print(xT.shape)
    run_mcmc_and_save_CoM(nmcmc, ux, x0, xT, eps, log_omega, n_particles, n_dimensions, device, back_coeff,get_log_omega_J, K_x=1, K_eps=1, if_eps=False,path='data/CGN-H1')
    clean_up()
